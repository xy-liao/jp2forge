        ...
        with self._lock:
            ...
            if self._free_blocks:
                ...
                if block_id >= 0:
                    ...
                    logger.debug(f"Reused memory block {block_id} of size {self._block_sizes[block_id]/1024/1024:.1f}MB")
...
class StreamingImageProcessor:
    ...
    def initialize_memory_pool(
        ...
        logger.info(f"Initialized optimized memory pool with {size_mb}MB default block size, {max_blocks} max blocks")
