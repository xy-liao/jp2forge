    ...
    def _parse_jpylyzer_output(self, xml_output: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if file_elem is not None:
                ...
                # Get warnings
                warnings_elems = file_elem.findall(".//jpy:warnings/jpy:warning", ns) or file_elem.findall(".//warnings/warning")
                if warnings_elems:
                    for warning in warnings_elems:
                        if warning.text:
                            result["warnings"].append(warning.text)
                # Get properties
                props_elem = file_elem.find(".//jpy:properties", ns) or file_elem.find(".//properties")
